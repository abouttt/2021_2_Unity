...
public class SoundManager
{
    ...
    public void Play(string path, Define.Sound type = Define.Sound.Effect, float pich = 1.0f)
    {
        AudioClip audioClip = GetOrAddAudioClip(path, type);
        Play(audioClip, type, pich);
    }

    public void Play(AudioClip audioClip, Define.Sound type = Define.Sound.Effect, float pich = 1.0f)
    {
        if (audioClip == null)
            return;
